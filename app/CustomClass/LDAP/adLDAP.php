...
namespace ESP\CustomClass\LDAP;
...
//echo dirname(__FILE__) . '/collections/adLDAPCollection.php<hr />';



use ESP\CustomClass\LDAP\collections\adLDAPCollection;
use ESP\CustomClass\LDAP\classes\adLDAPGroups;
use ESP\CustomClass\LDAP\classes\adLDAPUsers;
use ESP\CustomClass\LDAP\classes\adLDAPFolders;
use ESP\CustomClass\LDAP\classes\adLDAPUtils;
use ESP\CustomClass\LDAP\classes\adLDAPContacts;
use ESP\CustomClass\LDAP\classes\adLDAPExchange;
use ESP\CustomClass\LDAP\classes\adLDAPComputers;
...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@gbs.local";
    ...
    * @var string
    */
	protected $baseDn = "DC=gbs,DC=local"; 
    ...
    * @var array
    */
    protected $domainControllers = array("mnl01.gbs.local, evsi-mkt-dc01.gbs.local");
    ...
    * @var string
    */
	protected $adminUsername = "portal.auth";
    protected $adminPassword = "^#@!p0rt@lAU7332!#";
    ...
    */    
    public function adldap_schema($attributes){
        ...
        if ( isset($attributes["firstname"] && $attributes["surname"]){
