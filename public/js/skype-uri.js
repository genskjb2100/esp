...
var Skype = new function () {
		...
		function l(L) {
			...
			if (this.name === this.dropdownLinks.name) {
				...
				r.setAttribute("style", "display: none; position: absolute; margin-top: " + O + "px; margin-left: " + J + "px; width: 100px; padding: 5px; border: 1px solid #00AFF0;z-index:1; background-color: white; color: white; line-height: 20px; list-style: none; list-style-type: none;");
				...
				I.href = "javascript://";
				I.setAttribute("style", "text-decoration: none; color: #00AFF0; font-size: 12px;");
				...
				E.href = "javascript://";
				E.setAttribute("style", "text-decoration: none; color: #00AFF0; font-size: 12px;");
